package com.everdeng.android.lib.notchcompat
...
import com.everdeng.android.lib.core.helper.BarHelper
import com.everdeng.android.lib.core.helper.ScreenHelper
...
object NotchCompat {
    ...
    fun adaptNotchWithFullScreen(window: Window) {
        ScreenHelper.setFullScreen(window)
        adaptNotch(window)
    }
